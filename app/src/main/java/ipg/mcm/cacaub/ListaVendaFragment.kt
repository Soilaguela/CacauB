...
import ipg.mcm.cacaub.databinding.FragmentListaSeminariosBinding
...
class ListaVendaFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var _binding: FragmentListaSeminariosBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListaSeminariosBinding.inflate(inflater, container, false)
        return binding.root
